...
## Immediate
- [ ] <span style="color:red"> Deploy to Vercel.</span>
    - Secret management?
    - Security issues
    - Branding
...
- [ ] <span style="color:yellow">Work on reported bug issues</span>
## Eventual
...
## Alterations
- [ ] Centralize control over & experiment with **aesthetic/style** of the app.a
- [ ] Changed the "is suitable" toggle feature to be a **non-default** but **required** checkbox (?) input - Thereby avoiding lazy reports.
## New Features
